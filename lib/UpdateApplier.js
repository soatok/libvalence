...
module.exports = class UpdateApplier {
    ...
    /**
     * If a failure occurred, store the message here. This should never
     * be exposed to end users unless they're testing an integration.
     *
     * @returns {string}
     */
    getMessage() {
    ...
    /**
     * Parse the current version from the project's valence.json file.
     *
     * @returns {string}
     */
    ...
    /**
     * Get the parent directory, given any directory.
     *
     * @param {string} str
     * @returns {string}
     */
